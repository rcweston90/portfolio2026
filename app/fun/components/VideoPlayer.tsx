...
const VideoPlayer: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-black relative group">
      <video
        ref={videoRef}
        src="https://www.dropbox.com/scl/fi/o23tblc48kucwcjekgmuw/Your-Videos-The-Doll-Extended-HD.mp4?rlkey=blk31207hiyl2pz1ip8c3darq&st=n458pddf&dl=1"
        autoPlay
        muted={isMuted}
        loop
        playsInline
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-4">
            <input
              ...
              value={currentTime}
              onChange={handleSeek}
              className="w-full h-1 bg-white/20 rounded-lg appearance-none cursor-pointer accent-[var(--accent-primary)]"
              style={{
